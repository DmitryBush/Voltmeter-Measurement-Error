...
persons = {'Data_Person1': np.array([[7, 0.2], [1.65, 0.05], [4.4, 0.20], [0.7, 0.05], [275, 5]]),  # Черемин Д.
           'Data_Person2': np.array([[13, 0.2], [3.2, 0.20], [8, 0.20], [1.3, 0.05], [550, 50]]),  # Голубев А.
           'Data_Person3': np.array([[24.6, 0.5], [4.8, 0.20], [16, 0.50], [2.4, 0.20], [1500, 500]])}  # Бушуев Д.
